...
export const uiTranslations = {
  vi: {
    ...
    heroDescription:
      "Tôi xây dựng các giải pháp phần mềm đáng tin cậy và có khả năng mở rộng, tập trung vào hệ thống backend, kiến trúc phân tán và giải quyết các bài toán kỹ thuật thực tế.",
  ...
  en: {
    ...
    heroTitle: "Software Engineer · Backend Systems",
    heroDescription:
      "I build reliable and scalable software with a focus on backend systems, distributed architecture, and solving real-world engineering challenges.",
